# DeMendoza_Tovar_Alejandro_Menor.asm
# Programa: leer N (3..5) números y mostrar el menor (con validación de N)
.data
...
msg_res:   .asciiz "El numero menor es: "                            # Texto antes del resultado
...
main:
    ...
    # Leer primer número para inicializar el mínimo
    li   $v0, 4            # servicio 4 -> imprimir cadena
    ...
    move $t2, $v0          # $t2 = min_actual (semilla: primer número)
...
loop:
    ...
    bge  $t3, $t2, skip    # si $t3 >= $t2 -> no es menor -> saltar a skip
    move $t2, $t3          # si $t3 < $t2 -> actualizar min_actual = $t3
...
fin:
    ...
    syscall                # imprimir "El numero menor es: "

    li   $v0, 1            # servicio 1 -> imprimir entero
    move $a0, $t2          # pasar min_actual en $a0
